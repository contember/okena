...
export type ActionRequest =
        ...
        | {
                  action: "git_list_pull_requests";
                  project_id: string;
                  limit?: number;
          }
        | {
                  action: "git_file_contents";
                  project_id: string;
                  file_path: string;
                  mode?: DiffMode;
          }
        | {
                  action: "git_commit_graph";
                  project_id: string;
                  count: number;
                  branch?: string | null;
          }
        ...
        | {
                  action: "git_checkout_local_branch";
                  project_id: string;
                  branch: string;
          }
        | {
                  action: "git_checkout_remote_branch";
                  project_id: string;
                  remote_branch: string;
          }
        | {
                  action: "git_create_and_checkout_branch";
                  project_id: string;
                  new_name: string;
        ...
        | {
                  action: "reorder_project_in_folder";
                  folder_id: string;
                  project_id: string;
                  new_index: number;
          }
        ...
        | {
                  action: "update_project_hooks";
                  project_id: string;
                  hooks: ApiHooksConfig;
          }
        | {
                  action: "rename_project_directory";
                  project_id: string;
                  new_name: string;
          }
        ...
        | {
                  action: "move_project_out_of_folder";
                  project_id: string;
                  top_level_index: number;
          }
        ...
        | {
                  action: "reorder_worktree";
                  parent_id: string;
                  worktree_id: string;
                  new_index: number;
          }
        | {
                  action: "set_worktree_color_override";
                  project_id: string;
...
export function parseBinaryFrame(
        data: ArrayBuffer,
): { frameType: number; streamId: number; payload: Uint8Array } | null {
