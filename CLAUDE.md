...
├── app.rs                # Muxy - main app state, PTY event routing
...
|--------|----------|---------|
| App | `app.rs` | Muxy entity - owns RootView, Workspace, routes PTY events |
