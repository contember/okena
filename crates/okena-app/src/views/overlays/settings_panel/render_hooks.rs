...
impl SettingsPanel {
    pub(super) fn render_hooks(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let merge_env_note =
            "Extra env: $OKENA_BRANCH, $OKENA_TARGET_BRANCH, $OKENA_MAIN_REPO_PATH";
        ...
        div()
            ...
            .child(section_note(env_note, &t, cx))
            .child(section_note(multiline_hint, &t, cx))
            .child(
                section_container(&t)
            ...
            .child(section_note(merge_env_note, &t, cx))
            .child(section_note(
                "Close flow: stash \u{2192} fetch \u{2192} pre merge \u{2192} rebase \u{2192} merge \u{2192} post merge \u{2192} remove",
                &t,
                cx,
            ))
            .child(
