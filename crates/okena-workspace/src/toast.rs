//! Toast notification data types and manager.
//!
//! Pure data types for toast notifications, shared between workspace (hook_monitor)
//! and views (toast overlay rendering). The `ToastManager` is a GPUI Global that
//! holds the toast queue.
